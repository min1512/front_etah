...
class Httprequest
{
    ...
    public function get($uri, $params = array(), $format = NULL, $raw_result = FALSE)
    {
        if ($params)
        {
    	...
    	return $this->_call('get', $uri, NULL, $format, $raw_result);
    }


    public function post($uri, $params = array(), $format = NULL, $raw_result = FALSE)
    {
        return $this->_call('post', $uri, $params, $format, $raw_result);
    }


    public function put($uri, $params = array(), $format = NULL, $raw_result = FALSE)
    {
        return $this->_call('put', $uri, $params, $format, $raw_result);
    }


    public function delete($uri, $params = array(), $format = NULL, $raw_result = FALSE)
    {
        return $this->_call('delete', $uri, $params, $format, $raw_result);
    }
    ...
    protected function _call($method, $uri, $params = array(), $format = NULL, $raw_result = FALSE)
    {
    	if ($format !== NULL)
		{
			$this->format($format);
		...
		//원본 데이타 그대로 출력
		if($raw_result === TRUE) return $response;
