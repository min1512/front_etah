					...
					<div class="mypage_cont">
						<h3 class="title_page title_page__line title_page__mypage">환불&#47;입금내역</h3>
						...
						<div class="date_option">
							...
							<ul class="date_option_button">
								<li class="date_option_button_item<?=$date_type == '0' ? ' active' : ''?>" id="btn0">
									<button type="button" class="btn_white" onClick="javaScipt:jsSetDate(0,'<?=$date_w1?>');">1주일</button>
								</li>
								<li class="date_option_button_item<?=$date_type == '1' ? ' active' : ''?>" id="btn1">
									<!-- 활성화시 클래스 active 추가 -->
									<button type="button" class="btn_white" onClick="javaScipt:jsSetDate(1,'<?=$date_m1?>');">1개월</button>
								</li>
								<li class="date_option_button_item<?=$date_type == '2' ? ' active' : ''?>" id="btn2">
									<button type="button" class="btn_white" onClick="javaScipt:jsSetDate(2,'<?=$date_m2?>');">3개월</button>
								</li>
								<li class="date_option_button_item<?=$date_type == '3' ? ' active' : ''?>" id="btn3">
									<button type="button" class="btn_white" onClick="javaScipt:jsSetDate(3,'<?=$date_m3?>');">6개월</button>
								</li>
							</ul>
							...
							<table class="board_list_table">
								...
								<tbody>
									...
									<tr>
										...
										<td>2,000</td>
										<td>353,500</td>
										<td class="order_status"><span class="string">배송중</span><button type="button" class="btn_white btn_white__small">배송추적</button></td>
									</tr>
									<tr>
										<td class="order_number"><a href="#" class="link">2016-01-26-327668</a></td>
										<td class="image">
