...
//    $metaOgImg		= "http://www.etah.co.kr/assets/images/common/etah_image.png";
    ...
    <link rel="stylesheet" href="/assets/css/common.css?ver=2.7.7">
        ...
        for (var word in mobileKeyWords) {
            if (navigator.userAgent.match(mobileKeyWords[word]) != null){
                if(HOST == "staging.etah.co.kr") {
                    ...
                    if(URI != "") {location.href = "http://staging.etah.co.kr" + URI;}
                    else {location.href = "http://staging.etah.co.kr/";}
                    ...
                    if(URI != "") {
                        ...
                        location.href = "https://etahome.co.kr" + URI;
                    } else {
                        location.href = "https://etahome.co.kr";
                    }
                    ...
                    if(URI != "") {
                        ...
                        location.href = "http://staging.etahome.co.kr" + URI;
                    } else {
                        location.href = "http://staging.etahome.co.kr";
                    }
                }
            }
        }
