						...
						<table width="780" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
							<tbody>
								<tr>
									...
									<td width="28">
										<a href="#" style="display: block;text-align: center; padding-top: 8px;text-align: center;"><img src="http://etah.co.kr/assets/images/mail/bg_bar.gif" alt="" style="border: 0 none;" /></a>
									</td>
					...
					<td style="border-bottom: 1px solid #eee; height: 59px;">
						<table width="780" border="0" cellspacing="0" cellpadding="0">
							<tbody>
								...
								<tr>
									<td style="color:#999;font-size:14px;text-align: center;"><em style="color: #000; font-style:normal;">{{mem_name}}</em> 님 안녕하세요? 에타홈입니다.</td>
								</tr>
								<tr>
									<td height="15"></td>
								</tr>
								<tr>
									<td height="1" style="color:#999;font-size:14px;text-align: center;"><img src="http://etah.co.kr/assets/images/mail/bg_line.gif" alt="" style="border: 0 none;" /></td>
								</tr>
								<tr>
									<td height="23"></td>
								</tr>
								<tr>
									<td style="color:#999;font-size:12px;text-align: center;line-height: 18px;"><em style="color: #000; font-style:normal;"><?=date('Y')?>년 <?=date('m')?>월 <?=date('d')?>일</em> 주문하신 내역입니다.<br />항상 에타홈을 이용해 주셔서 감사합니다.</td>
								</tr>
								<tr>
									<td height="25"></td>
								</tr>
										...
										<table width="720" border="0" cellspacing="0" cellpadding="0" style=" margin: 0 auto;border-top:1px solid #f0f0f0;border-bottom:1px solid #f0f0f0;">
											...
											<tbody>
												<tr>
													...
													<td height="39" style="padding-left: 20px; color: #666;font-size:12px;text-align: left; border-bottom: 1px solid #f0f0f0;">에타홈</td>
												</tr>
												<tr>
								...
								<tr>
									<td style="text-align: left;padding-left: 30px;">
										<a href="<?=base_url()?>member/login?return_url=/mywiz/print_order" style="display: block; color: #000; font-size: 12px; line-height: 20px;background: url('http://etah.co.kr/assets/images/mail/bg_dot2.gif') no-repeat 0 9px;padding-left: 9px; text-decoration: none;">세금계산서 신청/구매영수증 출력/상품 배송상태 확인하기 <img src="http://etah.co.kr/assets/images/mail/bg_arrow.gif" alt="" style="vertical-align: 1px;" /></a>
					...
					<td style="border-bottom: 1px solid #999;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tbody>
								...
								<tr>
									<td rowspan="3" width="105" style="vertical-align: top;"><a href="<?=base_url()?>" style="font-size:26px;color: #a3a3a3; text-decoration: none;font-weight: bold;">ETAHOME</a></td>
